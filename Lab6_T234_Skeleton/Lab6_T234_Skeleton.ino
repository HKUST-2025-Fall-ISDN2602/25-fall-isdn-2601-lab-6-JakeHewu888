...
#define MOTOR_IN1 19  // Replace the ? with the GPIO pin you selected to connect IN2
#define MOTOR_IN2 5  // Replace the ? with the GPIO pin you selected to connect IN2

//Encoder Pin 
#define ENCODER_PINA 18 // Replace the ? with the GPIO pin you selected to connect encoder A
#define ENCODER_PINB 16 // Replace the ? with the GPIO pin you selected to connect encoder B
...
double getPosition() {
  ...
  position = float(encoderCount)*360.0/338; // Replace 1000.0 with the actual counts per revolution
...
void loop() {
        ...
        analogWrite(MOTOR_ENA,(200+int(abs(output))));   // Replace 128 with the the threshold value for your motor to move
